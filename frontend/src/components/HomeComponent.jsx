...
export default function Home(){
    ...
    return (
        <div>
            <GlobalStyle />
            <HomeStyle>
                <h1 className="text-ceemployeenter"> <b>Top Education</b></h1>
                <div class="box-area">
                    <div class="single-box">
                        ...
                        <div class="img-text">
                            <span class="header-text"><strong>Cargar pruebas.csv</strong></span>
                        </div>
                    </div>
                    <div class="single-box">
                        <a href="/estudiante">
                        ...
                        <div class="img-text">
                            <span class="header-text"><strong>Ingresar estudiante</strong></span>
                        </div>
                    </div>
                    <div class="single-box">
